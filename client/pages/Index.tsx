    ...
    <div style={{ fontFamily: 'Inter, system-ui, -apple-system', color: '#0A0A0A', backgroundColor: '#FFFFFF' }}>
      ...
      <section style={{ paddingTop: '96px', paddingBottom: '96px' }} className="sm:py-16 md:py-24">
        <div style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center', padding: '0 16px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }} className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
      ...
      <section style={{ paddingTop: '80px', paddingBottom: '80px' }} className="py-12 sm:py-20">
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 16px' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4" style={{ gap: '16px' }}>
            {[
              { title: "Enerji Verimliliği Analizi", desc: "Isıtma/soğutma/aydınlatma için optimizasyon." },
              { title: "İklim Senaryoları & Risk", desc: "Bölgesel verilerle 5–10 yıllık projeksiyon." },
              { title: "Pazar & Fiyat Öngörüleri", desc: "Global API trendleriyle planlama." },
              { title: "Yatırım Geri Dönüş (ROI)", desc: "Amortisman ve kârlılık senaryoları." },
              { title: "Su & Sulama Optimizasyonu", desc: "Su ayak izi ve verimlilik." },
              { title: "Hastalık & Zararlı Risk", desc: "Önleyici eylem planları." },
              { title: "Karbon Ayak İzi", desc: "Yeşil finansman uyumu." },
              { title: "Üretim Optimizasyonu (AI)", desc: "Verim senaryoları ve öneriler." },
              { title: "Substrate & Besin Yönetimi", desc: "EC/pH hedefleme stratejileri." },
              { title: "Işık/PPFD Planlama", desc: "DLI bazlı aydınlatma senaryosu." },
              { title: "Yapı & Kaplama Seçimi", desc: "Isı yükü ve transmisyon analizi." },
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 16px' }}>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6" style={{ gap: '24px' }}>
            ...
            >
              ...
              <ul style={{ color: '#374151', fontSize: '14px', marginBottom: '16px', listStyle: 'none', padding: 0 }}>
                <li style={{ marginBottom: '4px' }}>• Bitki fizyolojisi ve iklim yönetimi</li>
                <li style={{ marginBottom: '4px' }}>• Fizibilite & yatırım planlama</li>
                <li style={{ marginBottom: '4px' }}>• Hibe/teşvik başvuruları</li>
            ...
            >
              ...
              <ul style={{ color: '#374151', fontSize: '14px', marginBottom: '16px', listStyle: 'none', padding: 0 }}>
                <li style={{ marginBottom: '4px' }}>• Konsept tasarım & mühendislik</li>
                <li style={{ marginBottom: '4px' }}>• CAPEX/OPEX optimizasyonu</li>
      ...
      <section style={{ paddingTop: '80px', paddingBottom: '80px' }} className="py-12 sm:py-20">
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 16px', textAlign: 'center' }}>
          ...
          >
            <div style={{ backgroundColor: '#F3F4F6', padding: '10px 14px', borderRadius: '14px', marginBottom: '8px', display: 'inline-block' }}>
              Kullanıcı: Domates serası ROI analizi?
            </div>
            <div style={{ backgroundColor: '#111827', color: '#FFFFFF', padding: '10px 14px', borderRadius: '14px', marginBottom: '8px', display: 'inline-block', marginLeft: 'auto', float: 'right', clear: 'both' }}>
            ...
            <div style={{ backgroundColor: '#111827', color: '#FFFFFF', padding: '10px 14px', borderRadius: '14px', display: 'inline-block', marginLeft: 'auto', float: 'right' }}>
      ...
      {/* Güven & Uyum */}
      <div style={{ textAlign: 'center', color: '#6B7280', fontSize: '12px', paddingTop: '8px', paddingBottom: '32px' }}>
      ...
      <footer style={{ marginTop: '64px', borderTop: '1px solid #E5E7EB', backgroundColor: '#FFFFFF' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '24px 16px', flexWrap: 'wrap', gap: '12px' }} className="flex-col sm:flex-row">
          ...
          <div style={{ display: 'flex', gap: '16px', flexWrap: 'wrap' }} className="text-sm">
            ...
            <Link to="/moduller" style={{ color: '#374151', textDecoration: 'none' }}>Modüller</Link>
            <Link to="/danismanlik" style={{ color: '#374151', textDecoration: 'none' }}>Danışmanlık</Link>
            <Link to="/anahtar-teslim-sera" style={{ color: '#374151', textDecoration: 'none' }}>Anahtar Teslim</Link>
            <Link to="/destek" style={{ color: '#374151', textDecoration: 'none' }}>Destek</Link>
            <Link to="/blog" style={{ color: '#374151', textDecoration: 'none' }}>Blog</Link>
            <Link to="/iletisim" style={{ color: '#374151', textDecoration: 'none' }}>İletişim</Link>
