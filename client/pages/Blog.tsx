...
const blogPosts = [
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1574482620831-12d90e5d4088?w=800&h=400&fit=crop",
    featured: false,
  },
  {
  ...
  },
  {
    ...
    image:
      "https://images.unsplash.com/photo-1592417817098-8fd3d9eb14a5?w=800&h=400&fit=crop",
    featured: false,
  },
];
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center">
                <div className="order-2 lg:order-1">
                    ...
                    <span className="text-xs sm:text-sm text-text-secondary">
                      {
                        featuredPost.category[
                          language as keyof typeof featuredPost.category
                        ]
                      }
                    </span>
                    <span className="text-xs sm:text-sm text-text-secondary">
                  ...
                  <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-text-primary mb-3 sm:mb-4 group-hover:text-button-bg transition-colors">
                    {
                      featuredPost.title[
                        language as keyof typeof featuredPost.title
                      ]
                    }
                  </h2>
                  <p className="text-text-secondary leading-relaxed text-sm sm:text-base mb-4 sm:mb-6">
                    {
                      featuredPost.excerpt[
                        language as keyof typeof featuredPost.excerpt
                      ]
                    }
                  </p>
